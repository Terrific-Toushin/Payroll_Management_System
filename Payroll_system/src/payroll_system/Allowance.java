...
public class Allowance extends JFrame implements ActionListener {
    ...
    void addcomponant() {
        ...
        lbltxt_total.setBounds(350, 420, 90, 30);
        panel.add(lbltxt_total);
        lbltxt_total.setFont(lbltxt_total.getFont().deriveFont(20f));
    ...
    public void actionPerformed(ActionEvent einfo){
         ...
         String semp_id = txtid.getText();
            try{
                ...
                int j = Allowancedt_dao.save(emp_id,month,syear,novt,nmdcl,nlnc,nadv,ntotal);
                if (j > 0) {
                    lbltxt_total.setText(Double.toString(ntotal));
                } else {
                ...
                Double bns=Double.parseDouble(lbltxt_total.getText());
