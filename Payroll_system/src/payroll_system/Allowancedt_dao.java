...
public static int save(String emp_id,String month,String syear,double novt,double nmdcl,double nlnc,double nadv,double ntotal){
	int status=0;
	try{
		Connection con=DB.getConnection();
            try{
                String sql="update employee set Advance='"+nadv+"' where empid='"+emp_id+"'";
