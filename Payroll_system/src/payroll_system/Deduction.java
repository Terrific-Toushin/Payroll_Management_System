...
public class Deduction extends JFrame implements ActionListener {
    ...
    JLabel lbl_adv = new JLabel("Advance Paid :");
    ...
    String year[] = {"2016", "2015", "2014", "2013", "2012", "2011", "2010", "2009", "2008", "2007", "2006"};
    JComboBox comby = new JComboBox(year);
    JButton btn_ok = new JButton("Ok");
    JLabel lbl_gross = new JLabel("Gross salary :");
    ...
    private void addcomponant() {
        ...
        lbl_adv.setBounds(30, 240, 120, 30);
        panel.add(lbl_adv);
        lbl_adv.setFont(lbl_adv.getFont().deriveFont(15f));

        lbl_tadv.setBounds(150, 240, 200, 30);
        panel.add(lbl_tadv);
        ...
        lbl_gross.setBounds(40, 340, 120, 30);
        panel.add(lbl_gross);
        lbl_gross.setFont(lbl_gross.getFont().deriveFont(15f));
        
        lbl_grs.setBounds(150, 340, 120, 30);
        panel.add(lbl_grs);
        lbl_grs.setFont(lbl_grs.getFont().deriveFont(15f));
