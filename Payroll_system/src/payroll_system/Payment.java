...
public class Payment extends JFrame implements ActionListener,Printable{
    ...
    JLabel lbl_company=new JLabel("Zoncon Technology LTD");
    JLabel lbl_contact=new JLabel("Contact No:01813384717");
    ...
    private void addcomp() {
        ...
        lbl_month.setBounds(20, 60, 120, 35);
        panel.add(lbl_month);
        lbl_month.setFont(lbl_month.getFont().deriveFont(15f));

        combm.setBounds(90, 60, 90, 35);
        panel.add(combm);

        lblyear.setBounds(200, 60, 120, 35);
        panel.add(lblyear);
        lblyear.setFont(lblyear.getFont().deriveFont(15f));

        comby.setBounds(250, 60, 90, 35);
        panel.add(comby);

        btn_ok.setBounds(360, 50, 60, 45);
        panel.add(btn_ok);
        btn_ok.addActionListener(this);
        btn_ok.setFont(btn_ok.getFont().deriveFont(15f));

       lbl_company.setBounds(150, 115, 300, 35);
